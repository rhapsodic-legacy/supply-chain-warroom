...
def generate_risk_events(
    ...
    india_suppliers = [s for s in suppliers if s["region"] == "South Asia"]
    ...
    rotterdam_routes = [r for r in routes if "Rotterdam" in r["origin_port"] or "Rotterdam" in r["destination_port"]]
    ...
    for rt in shanghai_routes[:4]:
        impacts.append(_make_impact(rng, evt1_id, "route", rt["id"], rt["name"], rng.uniform(1.8, 3.0)))
    for sup in rng.sample(asia_suppliers, k=min(3, len(asia_suppliers))):
        impacts.append(_make_impact(rng, evt1_id, "supplier", sup["id"], sup["name"], rng.uniform(1.5, 2.5)))
    ...
    for rt in rotterdam_routes[:5]:
        impacts.append(_make_impact(rng, evt2_id, "route", rt["id"], rt["name"], rng.uniform(2.0, 3.5)))
    for sup in rng.sample(europe_suppliers, k=min(2, len(europe_suppliers))):
        impacts.append(_make_impact(rng, evt2_id, "supplier", sup["id"], sup["name"], rng.uniform(1.3, 1.8)))
    ...
    for sup in china_suppliers[:4]:
        impacts.append(_make_impact(rng, evt3_id, "supplier", sup["id"], sup["name"], rng.uniform(1.6, 2.8)))
    for rt in (shenzhen_routes[:3] + shanghai_routes[:2]):
        impacts.append(_make_impact(rng, evt3_id, "route", rt["id"], rt["name"], rng.uniform(1.3, 2.0)))
    ...
    _historical_templates = [
        {
            ...
            "severity": "high", "score": 0.72, "region": "East Asia", "days_ago": 240, "duration": 6,
        },
        {
            ...
            "severity": "high", "score": 0.78, "region": "East Asia", "days_ago": 210, "duration": 5,
        },
        {
            ...
            "severity": "high", "score": 0.68, "region": "East Asia", "days_ago": 195, "duration": 21,
        },
        {
            "event_type": "geopolitical",
            ...
            "severity": "medium", "score": 0.55, "region": "South Asia", "days_ago": 180, "duration": 90,
        },
        {
            ...
            "severity": "high", "score": 0.65, "region": "North America", "days_ago": 125, "duration": 12,
        },
        {
            "event_type": "labor_strike",
            ...
            "severity": "medium", "score": 0.58, "region": "North America", "days_ago": 160, "duration": 8,
        },
        {
            "event_type": "weather",
            ...
            "severity": "medium", "score": 0.48, "region": "Europe", "days_ago": 100, "duration": 5,
        },
        {
            "event_type": "port_closure",
            ...
            "severity": "high", "score": 0.71, "region": "North America", "days_ago": 85, "duration": 14,
        },
        {
            "event_type": "supplier_delay",
            ...
            "severity": "high", "score": 0.70, "region": "East Asia", "days_ago": 220, "duration": 14,
        },
        {
            "event_type": "geopolitical",
            ...
            "severity": "medium", "score": 0.52, "region": "East Asia", "days_ago": 150, "duration": 45,
        },
        {
            "event_type": "weather",
            ...
            "severity": "critical", "score": 0.90, "region": "North America", "days_ago": 200, "duration": 8,
        },
        {
            "event_type": "demand_spike",
            ...
            "severity": "medium", "score": 0.60, "region": "Europe", "days_ago": 140, "duration": 30,
        },
        {
            "event_type": "supplier_delay",
            ...
            "severity": "high", "score": 0.73, "region": "South Asia", "days_ago": 110, "duration": 25,
        },
        {
            "event_type": "port_closure",
            ...
            "severity": "critical", "score": 0.88, "region": "East Asia", "days_ago": 60, "duration": 5,
        },
        {
            "event_type": "labor_strike",
            ...
            "severity": "medium", "score": 0.50, "region": "Europe", "days_ago": 75, "duration": 4,
        },
        {
            "event_type": "weather",
            ...
            "severity": "high", "score": 0.69, "region": "South Asia", "days_ago": 170, "duration": 8,
        },
        {
            "event_type": "geopolitical",
            ...
            "severity": "high", "score": 0.75, "region": "East Asia", "days_ago": 90, "duration": 60,
        },
        {
            "event_type": "supplier_delay",
            ...
            "severity": "medium", "score": 0.55, "region": "East Asia", "days_ago": 130, "duration": 22,
        },
        {
            "event_type": "demand_spike",
            ...
            "severity": "high", "score": 0.67, "region": "North America", "days_ago": 50, "duration": 21,
        },
        {
            "event_type": "port_closure",
            ...
            "severity": "medium", "score": 0.52, "region": "South America", "days_ago": 40, "duration": 5,
        },
    ]
    ...
    for tpl in _historical_templates:
        ...
        for entity_type, entity_id, entity_name in chosen:
            impacts.append(
                _make_impact(rng, evt_id, entity_type, entity_id, entity_name, rng.uniform(1.2, 2.5))
            )
