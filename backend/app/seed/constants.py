...
PRODUCT_CATALOG: list[dict] = [
    ...
    {
        "sku": "ELEC-MCU-7200",
        "name": "ARM Cortex-M7 Microcontroller",
        "category": "electronics",
        "unit_cost": 8.50,
        "weight_kg": 0.02,
        "is_critical": True,
        "description": "High-performance 32-bit MCU for industrial IoT and motor control",
    },
    {
        "sku": "ELEC-MEM-3200",
        "name": "DDR5 16GB Memory Module",
        "category": "electronics",
        "unit_cost": 42.00,
        "weight_kg": 0.03,
        "is_critical": True,
        "description": "Server-grade DDR5-4800 ECC registered memory",
    },
    {
        "sku": "ELEC-CAP-1000",
        "name": "MLCC 100uF Capacitor Array",
        "category": "electronics",
        "unit_cost": 0.85,
        "weight_kg": 0.001,
        "is_critical": True,
        "description": "Multi-layer ceramic capacitor pack for power filtering",
    },
    {
        "sku": "ELEC-SEN-9050",
        "name": "LiDAR Proximity Sensor",
        "category": "electronics",
        "unit_cost": 135.00,
        "weight_kg": 0.15,
        "is_critical": False,
        "description": "Time-of-flight LiDAR module for autonomous systems",
    },
    {
        "sku": "ELEC-PCB-4400",
        "name": "8-Layer HDI PCB Blank",
        "category": "electronics",
        "unit_cost": 24.50,
        "weight_kg": 0.08,
        "is_critical": False,
        "description": "High-density interconnect board for miniaturized assemblies",
    },
    {
        "sku": "ELEC-DIS-2100",
        "name": 'OLED 6.7" Display Panel',
        "category": "electronics",
        "unit_cost": 67.00,
        "weight_kg": 0.04,
        "is_critical": False,
        "description": "AMOLED flexible display for consumer devices",
    },
    {
        "sku": "ELEC-BAT-5500",
        "name": "Li-Ion 5000mAh Cell",
        "category": "electronics",
        "unit_cost": 5.20,
        "weight_kg": 0.07,
        "is_critical": True,
        "description": "Cylindrical lithium-ion cell for EV battery packs",
    },
    # --- Automotive (6) ---
    {
        "sku": "AUTO-BRK-3100",
        ...
        "weight_kg": 2.50,
        "is_critical": True,
        "description": "High-temp ceramic compound front/rear brake pads",
    },
    {
        "sku": "AUTO-WIR-6600",
        "name": "CAN Bus Wiring Harness",
        "category": "automotive",
        "unit_cost": 78.00,
        "weight_kg": 3.20,
        "is_critical": True,
        "description": "Full vehicle CAN-FD wiring loom with connectors",
    },
    {
        "sku": "AUTO-TUR-1200",
        ...
        "weight_kg": 8.50,
        "is_critical": False,
        "description": "Variable geometry twin-scroll turbo for 2.0L engines",
    },
    {
        "sku": "AUTO-SUS-8800",
        "name": "Adaptive Damper Assembly",
        "category": "automotive",
        "unit_cost": 195.00,
        "weight_kg": 5.40,
        "is_critical": False,
        "description": "Electronically controlled magnetorheological damper",
    },
    {
        "sku": "AUTO-CAT-4500",
        "name": "Catalytic Converter Core",
        "category": "automotive",
        "unit_cost": 310.00,
        "weight_kg": 4.80,
        "is_critical": True,
        "description": "Palladium/rhodium substrate for Euro 7 compliance",
    },
    {
        "sku": "AUTO-ECU-7700",
        "name": "ADAS Control Module",
        "category": "automotive",
        "unit_cost": 245.00,
        "weight_kg": 0.35,
        "is_critical": True,
        "description": "Advanced driver-assistance ECU with sensor fusion",
    },
    # --- Pharma (6) ---
    {
        "sku": "PHRM-API-1100",
        "name": "Ibuprofen API Powder",
        "category": "pharma",
        "unit_cost": 18.00,
        "weight_kg": 1.00,
        "is_critical": True,
        "description": "Active pharmaceutical ingredient, USP grade bulk",
    },
    {
        "sku": "PHRM-VIA-2200",
        "name": "Borosilicate Glass Vials 10mL",
        "category": "pharma",
        "unit_cost": 0.45,
        "weight_kg": 0.02,
        "is_critical": True,
        "description": "Type I borosilicate vials for injectable formulations",
    },
    {
        "sku": "PHRM-CAP-3300",
        "name": "Enteric Coating Capsules",
        "category": "pharma",
        "unit_cost": 0.12,
        "weight_kg": 0.001,
        "is_critical": False,
        "description": "Acid-resistant HPMC capsules size 0",
    },
    {
        "sku": "PHRM-EXC-4400",
        ...
        "weight_kg": 25.00,
        "is_critical": False,
        "description": "Pharmaceutical excipient, 50kg drum",
    },
    {
        "sku": "PHRM-SYR-5500",
        "name": "Pre-Filled Syringe Bodies",
        "category": "pharma",
        "unit_cost": 1.80,
        "weight_kg": 0.01,
        "is_critical": True,
        "description": "COP polymer syringe barrels with luer lock",
    },
    {
        "sku": "PHRM-FIL-6600",
        "name": "Sterile Filtration Membrane",
        "category": "pharma",
        "unit_cost": 95.00,
        "weight_kg": 0.30,
        "is_critical": False,
        "description": "0.22um PVDF membrane cartridge for bioprocessing",
    },
    # --- Consumer Goods (6) ---
    {
        "sku": "CONS-TEX-1100",
        ...
        "weight_kg": 0.30,
        "is_critical": False,
        "description": "GOTS-certified 180gsm single jersey roll",
    },
    {
        "sku": "CONS-PKG-2200",
        "name": "Recycled Kraft Packaging Box",
        "category": "consumer_goods",
        "unit_cost": 0.95,
        "weight_kg": 0.25,
        "is_critical": False,
        "description": "FSC-certified corrugated shipper box 12x10x8",
    },
    {
        "sku": "CONS-PLM-3300",
        "name": "Fragrance Oil Blend (Cedarwood)",
        "category": "consumer_goods",
        "unit_cost": 28.00,
        "weight_kg": 0.50,
        "is_critical": False,
        "description": "Clean-label essential oil blend for home goods",
    },
    {
        "sku": "CONS-CER-4400",
        "name": "Porcelain Dinnerware Set Blanks",
        "category": "consumer_goods",
        "unit_cost": 15.00,
        "weight_kg": 4.00,
        "is_critical": False,
        "description": "Unglazed 12-piece set for custom finishing",
    },
    {
        "sku": "CONS-SOL-5500",
        "name": "Monocrystalline Solar Cell 6x6",
        "category": "consumer_goods",
        "unit_cost": 3.80,
        "weight_kg": 0.02,
        "is_critical": False,
        "description": "22% efficiency cells for portable charger kits",
    },
    {
        "sku": "CONS-LED-6600",
        "name": "Smart LED Bulb PCB Assembly",
        "category": "consumer_goods",
        "unit_cost": 4.20,
        "weight_kg": 0.05,
        "is_critical": False,
        "description": "WiFi-enabled dimmable LED driver board",
    },
]
